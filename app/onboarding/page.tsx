  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md mb-8 flex items-center justify-between px-2">
        {[1, 2, 3].map((i) => (
          <div key={i} className="flex flex-col items-center gap-2">
             <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold border-2 transition-all ${
                step >= i ? "bg-slate-900 text-white border-slate-900" : "bg-white text-slate-300 border-slate-200"
             }`}>
        ...
        <div className="absolute w-full max-w-[300px] h-[2px] bg-slate-200 -z-10 top-[50%] translate-y-[-50%] hidden md:block" /> 
      </div>
      ...
      <Card className="w-full max-w-md shadow-xl border-slate-200">
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
               <div className="space-y-2">
                 ...
                 <div className="relative">
                    ...
                    <Input className="pl-9" placeholder="Your Full Name" value={formData.full_name} onChange={e => updateForm("full_name", e.target.value)} />
                 </div>
               </div>
               <div className="space-y-2">
             ...
             <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input className="pl-9" placeholder="e.g. Neon Studio" value={formData.company_name} onChange={e => updateForm("company_name", e.target.value)} />
                    </div>
                </div>
                <div className="space-y-2">
        ...
        <CardFooter className="flex justify-between">
          ...
          {step < 3 ? (
             <Button onClick={() => setStep(step + 1)} disabled={!formData.full_name && step === 1 || !formData.company_name && step === 2}>
                Next <ArrowRight className="ml-2 h-4 w-4" />
             </Button>
          ) : (
             <Button onClick={handleFinish} disabled={loading || !formData.company_description} className="bg-blue-600 hover:bg-blue-700">
